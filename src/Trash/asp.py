...
drp_path = "C:/Users/ave41/OneDrive - University of Canterbury/Master's 2021/ASTR480 Research/ASTR480 Code/01 Data Reduction Pipeline/DataReductionPipeline/src"
os.chdir(drp_path) #from now on, we are in this directory

# importing functions
from drp_funcs import *

# initialising starting directory
astrometry_path = "C:/Users/ave41/OneDrive - University of Canterbury/Master's 2021/ASTR480 Research/ASTR480 Code/02 Astrometry Solving Pipeline/src"
os.chdir(astrometry_path) #from now on, we are in this directory
...
for reduced_ALERT_file in testdata:
    ...
    while try_again:
        try:
            if not submission_id:
                ...
                print("FAIL at first pass for {}!".format(reduced_ALERT_file))
                wcs_header = ast.monitor_submission(submission_id,
                                                    solve_timeout=10000)
        except TimeoutError as e:
            print("TIMEOUT ERROR for {}!".format(reduced_ALERT_file))
    ...
    if wcs_header:
        print("SUCCESSFUL SOLVE for {}!".format(reduced_ALERT_file))
        ccd_obj = wcs_writer(wcs_header, reduced_ALERT_file, WCS_test_cal_path)
    else:
        # Code to execute when solve fails
        print("FAILED SOLVE for {}.".format(reduced_ALERT_file))
